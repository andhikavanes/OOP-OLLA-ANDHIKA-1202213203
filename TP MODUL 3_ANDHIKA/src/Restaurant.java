public class Restaurant implements Runnable {
    private boolean waitingForPicup = false;
    ...
    public void setWaitingForPickup(boolean waitingForPicup) {
        this.waitingForPicup = waitingForPicup;
